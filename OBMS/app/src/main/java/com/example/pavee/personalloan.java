...
//k < 1000000 || k > 2500000
    public void update_db(View v) {
        ...
        //8015150522
        //975149425000
        else if (p.length()!=0 && p1.length()!=0 && (k >1000000||k ==1000000) && (k < 2500000||k==2500000)) {
...
//                            Toast.makeText(getApplicationContext(), p + " " + document.getData().get("Loan Amount"), Toast.LENGTH_SHORT).show();
                            //Toast.makeText(getApplicationContext(),  " CHECKKKK" + document.getData().get("Personal Loan Amount"), Toast.LENGTH_SHORT).show();
                            int val_check= Integer.parseInt(document.getData().get("Loan Amount").toString());
                            if (val_check==0) {
                                Map<String, Object> data1 = new HashMap<>();
                                data1.put("Loan Type","Personal");
