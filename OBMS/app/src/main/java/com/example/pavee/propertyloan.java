...
public class propertyloan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_propertyloan);
    ...
    public void update_db(View v) {
        ...
        //8015150522
        //9751494250
        else if (p.length()!=0 && p1.length()!=0 && (k >10000000||k ==10000000) && (k < 75000000||k==75000000)) {
...
//                            Toast.makeText(getApplicationContext(), p + " " + document.getData().get("Loan Amount"), Toast.LENGTH_SHORT).show();
                            //Toast.makeText(getApplicationContext(),  " CHECKKKK" + document.getData().get("Property Loan Amount"), Toast.LENGTH_SHORT).show();
                            int val_check= Integer.parseInt(document.getData().get("Loan Amount").toString());
                            if (val_check== 0) {
                                Map<String, Object> data1 = new HashMap<>();
                                data1.put("Loan Type","Property");
